...
function getStatusCashout($request_id) {
    
// URL của API và tham số apiKey
$apiKey = API_KEY; 

$url = API_BASE_URL . '/api/v1/Cashout/GetStatus?apiKey=' . urlencode($apiKey) . '&request_id=' . urlencode($request_id); 
...
getStatusCashout('31082024095044');
?>
