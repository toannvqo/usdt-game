/* Rainbow v2.1.3 rainbowco.de | included languages: c, coffeescript, csharp, css, d, generic, go, haskell, html, java, javascript, json, lua, php, python, r, ruby, scheme, shell, smalltalk, sql */
!function(e, t) {
    ...
    function l() {
        return (R || null === j) && (j = c(f, Prism)),
        j
    }
    function d(e, t) {
        function n(a) {
            a.data.id === e.id && (t(a.data),
    ...
    function g(e, t, n) {
        return function(r) {
            ...
            "PRE" === e.parentNode.tagName && e.parentNode.classList.remove("loading"),
            M && M(e, r.lang),
            0 === --t.c && n()
        }
    }
    ...
    function b(e, t) {
        ...
        for (var n = e.getElementsByTagName("pre"), r = e.getElementsByTagName("code"), a = [], o = [], i = 0, u = n; i < u.length; i += 1) {
            var s = u[i];
            h(s),
            s.getElementsByTagName("code").length ? s.getAttribute("data-trimmed") || (s.setAttribute("data-trimmed", !0),
            s.innerHTML = s.innerHTML.trim()) : a.push(s)
        }
    ...
    var M, Prism = function Prism(e) {
        ...
        function f(e) {
            var t = "";
            return e.ignoreCase && (t += "i"),
            e.multiline && (t += "m"),
            new RegExp(e.source,t)
        }
        function l(r, a, i) {
            function c(e) {
                return r.name && (e = n(r.name, e)),
                p[y] = {
                    replace: m[0],
                    "with": e
                },
            ...
            if (!m)
                return !1;
            !r.name && r.matches && "string" == typeof r.matches[0] && (r.name = r.matches[0],
            delete r.matches[0]);
            var b = m[0]
              , y = m.index + i
              , w = m[0].length + y;
