<?php
    ...
    define('id_admin','1');
    define('max_time_load','10');
    define('websoket','wss://ws.chanle3s.com');
    define('SECRET_KEY','asdasdasdddddddddddssasdqwefddd1d');
    
    
            // bank api
    define('API_BASE_URL','https://kingpay86.com');
    define('API_KEY','398953273a8591cd3214f07d72d35342ba4303f0bd2988fcf571cbb045ae555d');
    define('SIGN_KEY','pxt7tLpCWeCXPabmuXysMdjdbnlRjXty');
    define('CALLBACK_CASHIN_URL','https://webhook.site/d51dd800-3491-45cf-9daf-95f34aa5e193');
    define('CALLBACK_CASHOUT_URL','https://chanle3s.com/ajaxs/api/callback_cashout.php');
    
    define('IP_HOST','85.209.133.151');

    // bank aee_pay
    define('AEE_API_BASE_URL','https://aeeapi.aeepayment.com');
    define('AEE_MERCHANT_NO','1002184');
    define('AEE_TYPE','0');
    define('AEE_MD5KEY','fSTvIfYbcy950LBr');
?>