            ...
            <div class="subpage-wrapper">
                           <div class="text-center mb-3"
                                <button type="button" class="btn btn-success w-100 button-check-custom button-check-custom-nv" >
                                 <font color="#fff">Tổng tiền bạn đã chơi hôm nay :</font> <b class="money-day" style="color: #FFFF00;"><?= 
                    ...
                    <div class="dashbox">
                        <div class="dashbox__table-wrap dashbox__table-wrap--1" data-scrollbar="true" tabindex="-1"
                            ...
                            <div class="scroll-content">
                                    ...
                                    <input type="hidden" name="qId" id="_qid">
                            ...
                            <tbody id="nhiemvungay"> </tbody>
                                    ...
                                    <input type="hidden" name="Account" id="_account"
                                        value="01974974382c044065520d9edd237621">
                                    <input type="hidden" name="HLog" value="21e0be78-ae95-40cd-a856-8dc787739d73"
                                        id="_hlog">

                            </div>
                            <div class="scrollbar-track scrollbar-track-x show" style="display: none;">
                                <div class="scrollbar-thumb scrollbar-thumb-x"
                                    style="width: 660px; transform: translate3d(0px, 0px, 0px);"></div>
                            </div>
                            <div class="scrollbar-track scrollbar-track-y show" style="display: none;">
                                <div class="scrollbar-thumb scrollbar-thumb-y"
                                    style="height: 570px; transform: translate3d(0px, 0px, 0px);"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- view modal -->
                <div class="modal fade" id="modal-notes" tabindex="-1" aria-labelledby="modal-view"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal__content modal__content--view">
                                <div class="comments__autor">
                                    <img class="comments__avatar" src="https://chanlebank.vip/themes/images/user.png"
                                        alt="">
                                    <span class="comments__name">KuBank Thông Báo</span>
                                </div>
                                <p class="comments__text"></p>
                                <div class="modal__btns">
                                    <button class="modal__btn modal__btn--dismiss" type="button"
                                        data-bs-dismiss="modal" aria-label="Close"><span>Đóng</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- end view modal -->
                <div class="hidden">
                    <input type="hidden" name="Account" id="_account" value="051764bd8a51d87643af44751ba47d5b">
    ...
    <div id="ifr-bill-panel">
        <div class="bill-frame">
            <div class="bill-header">
                <span class="header-bill-text">SAO KÊ</span>
                <a href="javascript:void(0);" class="close-bill-frame">ĐÓNG</a>
            </div>
            <iframe id="show-bill-ifr" src="#"
                onload="resizeIframe(this)" style="height: 0px;"></iframe>
        </div>
    </div>
    <!-- JS -->
